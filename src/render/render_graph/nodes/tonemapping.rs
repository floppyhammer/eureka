...
impl Node for ToneMappingNode {
    ...
    fn node_resources(&self) -> crate::render::render_graph::resource::NodeResources {
        ...
        crate::render::render_graph::resource::NodeResources::new()
            .input(
                ...
                ResourceSpec::texture(0, 0, wgpu::TextureFormat::Rgba16Float, wgpu::TextureUsages::TEXTURE_BINDING, 1),
            )
            .output(
                standard_resources::final_output(),
                ResourceSpec::texture(0, 0, wgpu::TextureFormat::Bgra8UnormSrgb, wgpu::TextureUsages::RENDER_ATTACHMENT, 1),
            )
    }
    ...
    fn prepare(&mut self, context: &mut FrameContext) {
        ...
        context.pool.add_bind_group_layout("tonemapping_bind_group_layout", bind_group_layout);
    }
    ...
    fn run(&mut self, context: &mut FrameContext) {
        ...
        let input_texture = context.get_texture_by_id(&standard_resources::main_color(), input_key);
        ...
        let bind_group_layout = context.pool.get_bind_group_layout("tonemapping_bind_group_layout").unwrap().clone();
        let bind_group = context.create_bind_group(&bind_group_layout, vec![input_texture.id], |ctx| {
