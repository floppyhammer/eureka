...
use crate::render::light::{ClusterConfig, LightUniform, CLUSTER_GRID_SIZE, MAX_SHADOWED_POINT_LIGHTS};
use crate::render::render_backend::PreparedFrame;
use crate::render::render_graph::{standard_resources, FrameContext, Node, ResourceSpec, SamplerKey, TextureKey};
use std::any::Any;
...
impl Node for VolumetricNode {
    ...
    fn node_resources(&self, _prepared: &PreparedFrame) -> crate::render::render_graph::resource::NodeResources {
        use crate::render::camera::CameraUniform;
        use crate::render::light::{LightUniform, PointLightUniform, ClusterConfig, MAX_SHADOWED_POINT_LIGHTS};
        ...
        crate::render::render_graph::resource::NodeResources::new()
            ...
            .input(standard_resources::light_uniform_buffer(), ResourceSpec::buffer(size_of::<LightUniform>() as u64, wgpu::BufferUsages::UNIFORM))
            .input(standard_resources::point_light_storage_buffer(), ResourceSpec::buffer((size_of::<PointLightUniform>() * 1024) as u64, wgpu::BufferUsages::STORAGE))
            ...
            .input(standard_resources::point_shadow_map(), ResourceSpec::Texture(TextureKey {
                width: 512,
                height: 512,
            ...
            .input(standard_resources::directional_shadow_map(), ResourceSpec::Texture(TextureKey {
                width: 2048,
                height: 2048,
                format: Some(Texture::DEPTH_FORMAT),
                usage: wgpu::TextureUsages::RENDER_ATTACHMENT | wgpu::TextureUsages::TEXTURE_BINDING,
            ...
            .input(standard_resources::shadow_cascade_buffer(), ResourceSpec::buffer(size_of::<crate::render::light::CascadeUniform>() as u64, wgpu::BufferUsages::UNIFORM))
            .output(standard_resources::volumetric_lighting_texture(), ResourceSpec::Texture(TextureKey {
    ...
    fn run(&mut self, context: &mut FrameContext) {
            ...
            let layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[&device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    entries: &[
                        ...
                        wgpu::BindGroupLayoutEntry { binding: 4, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::StorageTexture { access: wgpu::StorageTextureAccess::WriteOnly, format: wgpu::TextureFormat::Rgba16Float, view_dimension: wgpu::TextureViewDimension::D3 }, count: None },
                        wgpu::BindGroupLayoutEntry { binding: 5, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::Texture { multisampled: false, view_dimension: wgpu::TextureViewDimension::CubeArray, sample_type: wgpu::TextureSampleType::Depth }, count: None },
                        wgpu::BindGroupLayoutEntry { binding: 6, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::Sampler(wgpu::SamplerBindingType::Comparison), count: None },
                        // Directional Shadow
                        wgpu::BindGroupLayoutEntry { binding: 7, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::Texture { multisampled: false, view_dimension: wgpu::TextureViewDimension::D2Array, sample_type: wgpu::TextureSampleType::Depth }, count: None },
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 1, resource: light_uniform.buffer.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 2, resource: point_lights.buffer.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 3, resource: config_buffer.buffer.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 4, resource: wgpu::BindingResource::TextureView(&volumetric_view.0) },
                wgpu::BindGroupEntry { binding: 5, resource: wgpu::BindingResource::TextureView(&shadow_view.0) },
                wgpu::BindGroupEntry { binding: 6, resource: wgpu::BindingResource::Sampler(&shadow_sampler) },
                wgpu::BindGroupEntry { binding: 7, resource: wgpu::BindingResource::TextureView(&dir_shadow_view.0) },
                wgpu::BindGroupEntry { binding: 8, resource: cascade_buffer.buffer.as_entire_binding() },
            ],
            label: None,
        });

        let mut cpass = context.encoder.begin_compute_pass(&wgpu::ComputePassDescriptor { label: Some("Volumetric Pass"), timestamp_writes: None });
