...
pub(crate) fn prepare_sky(render_resources: &mut SkyRenderResources, render_server: &RenderServer, texture_cache: &TextureCache, texture_id: &TextureId, camera_bind_group_layout: &wgpu::BindGroupLayout) {
    let device = &render_server.device;
